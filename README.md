...
| Platform | Link |
|----------|------|
| macOS (Universal) | [Download v0.2.5](https://github.com/maxacode/evtx-Enrich/releases/download/v0.2.5/evtx-Enrich_0.2.5_universal.dmg) |
| Windows (x64) | [Download v0.2.5](https://github.com/maxacode/evtx-Enrich/releases/download/v0.2.5/evtx-Enrich_0.2.5_x64_en-US.msi) |
