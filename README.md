...
| Platform | Link |
|----------|------|
| macOS (Universal) | [Download Dev build #15](https://github.com/maxacode/evtx-Enrich/releases/download/v0.2.5-dev.15/evtx-Enrich_0.2.5_universal.dmg) |
| Windows (x64) | [Download Dev build #15](https://github.com/maxacode/evtx-Enrich/releases/download/v0.2.5-dev.15/evtx-Enrich_0.2.5_x64_en-US.msi) |
