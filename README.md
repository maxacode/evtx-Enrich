...
| Platform | Link |
|----------|------|
| macOS (Universal) | [Download Dev build #7](https://github.com/maxacode/evtx-Enrich/releases/download/v0.2.0-dev.7/evtx-Enrich_0.2.0_universal.dmg) |
| Windows (x64) | [Download Dev build #7](https://github.com/maxacode/evtx-Enrich/releases/download/v0.2.0-dev.7/evtx-Enrich_0.2.0_x64_en-US.msi) |
